...
class ClienteSmtp(object):
    def envioSmtp(self):
        ...
        <td align="left" style="padding:0;Margin:0">"""+self.infoDataHora()+"""</td>
        </tr>
        <tr style="background-color:#f4f4f4">
        ...
        <p</p>
        <b><p align="center"><font size=+>Dados do Servidor</font></b></p>
        <tr style="background-color:#ffffff">
        ...
        <tr>
        <td style="padding:0;Margin:0;background-color:#4caf50;color:white" align="center" width="77%">77%</td>
        ...
        <tr style="background-color:#ffffff">
        <th align="left">Mem&oacute;ria:</th>
        <td align="left" style="padding:0;Margin:0">
        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <tr>
        <td align="left" style="padding:0;Margin:0">Dispon&iacute;vel:</td>
        <td align="left" style="padding:0;Margin:0">"""+self.memoriaDisponivelServidor()+""" GB</td>
        </tr>
        <tr>
        <td align="left" style="padding:0;Margin:0">Em Uso:</td>
        <td align="left" style="padding:0;Margin:0">"""+self.memoriaUsadaServidor()+""" GB</td>
        </tr>
        <tr>
        <td align="left" style="padding:0;Margin:0">Total:</td>
        <td align="left" style="padding:0;Margin:0">"""+self.memoriaTotalServidor()+""" GB</td>
        </tr>
        <tr>
        <td align="left" style="padding:0;Margin:0"> Porcentagem de uso: </td>
        <td align="left" style="padding:0;Margin:0">
        ...
        <tr>
        <td align="left" style="padding:0;Margin:0">Dispon&iacute;vel:</td>
        <td align="left" style="padding:0;Margin:0">"""+self.discoDisponivelServidor()+""" GB</td>
        </tr>
        <tr>
        <td align="left" style="padding:0;Margin:0">Em Uso:</td>
        <td align="left" style="padding:0;Margin:0">"""+self.discoUsadoServidor()+"""" Gb</td>
        </tr>
        <tr>
        <td align="left" style="padding:0;Margin:0">Total:</td>
        <td align="left" style="padding:0;Margin:0">"""+self.discoTotalServidor()+""" Gb</td>
        </tr>
        <tr>
        <td align="left" style="padding:0;Margin:0"> Porcentagem de uso: </td>
        <td align="left" style="padding:0;Margin:0">
        ...
        <p</p>
        <b><p align="center"><font size=+>Dados do Dropbox</font></b></p>
        <tr style="background-color:#ffffff">
        <th align="left">Armazenamento:</th>
        <td align="left" style="padding:0;Margin:0">
        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
        <tr>
        <td align="left" style="padding:0;Margin:0"> Porcentagem de uso: </td>
        ...
        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border:2px solid #293a4a;margin:1px;padding:0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
        <td style="padding:0;Margin:0;background-color:#4caf50;color:white" align="center" width="87%">87%</td>
        <td style="padding:0;Margin:0;background-color:#ffffff" width="83%"></td>
        </tr>
        </table></td>
        </tr>
        ...
        <tr>
        <td class="es-stripe-html" align="center" style="padding:0;Margin:0">
        <table class="es-footer-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:803px">
        ...
        <td align="center" valign="top" style="padding:0;Margin:0;padding-right:40px"><a target="_blank" href="https://wa.me/5584991182908" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px"><img title="Suporte T&eacute;cnico" src="https://vumqey.stripocdn.email/content/assets/img/messenger-icons/circle-white-bordered/whatsapp-circle-white-bordered.png" alt="Whatsapp" height="32" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td>
        <td align="center" valign="top" style="padding:0;Margin:0"><a target="_blank" href="https://wa.me/5584991178963" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px"><img title="Suporte Sistema" src="https://vumqey.stripocdn.email/content/assets/img/messenger-icons/circle-white-bordered/whatsapp-circle-white-bordered.png" alt="Whatsapp" height="32" width="32" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
    ...
    def dadosSmtp(self):
        eSmtp = ["a"]
        for i in eSmtp:
            self.email = "paulo.junior.ph@gmail.com"
            self.senha = "khxnlpynbikgbrkb"
            self.envioSmtp()
            
class Main(ClienteSmtp, InfoServidor):
    def __init__(self):
        #self.status = str(sys.argv[1])
        self.memoriaTuple = 1545.0
        self.diskTupla = 5451.0
        self.dadosSmtp()
Main()
